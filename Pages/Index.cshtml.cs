...
new SelectListItem { Value = "Pacific/Johnston", Text = "Pacific/Johnston" },
...
new SelectListItem { Value = "America/Santa_Isabel", Text = "America/Santa_Isabel" },
...
new SelectListItem { Value = "America/Fort_Nelson", Text = "America/Fort_Nelson" },
...
new SelectListItem { Value = "America/Coral_Harbour", Text = "America/Coral_Harbour" },
...
new SelectListItem { Value = "America/Montreal", Text = "America/Montreal" },
...
new SelectListItem { Value = "America/Louisville", Text = "America/Louisville" },
...
new SelectListItem { Value = "America/Indianapolis", Text = "America/Indianapolis" },
...
new SelectListItem { Value = "America/Buenos_Aires", Text = "America/Buenos_Aires" },
...
new SelectListItem { Value = "America/Catamarca", Text = "America/Catamarca" },
new SelectListItem { Value = "America/Cordoba", Text = "America/Cordoba" },
new SelectListItem { Value = "America/Jujuy", Text = "America/Jujuy" },
new SelectListItem { Value = "America/Mendoza", Text = "America/Mendoza" },
...
new SelectListItem { Value = "Atlantic/Faeroe", Text = "Atlantic/Faeroe" },
new SelectListItem { Value = "Europe/Guernsey", Text = "Europe/Guernsey" },
new SelectListItem { Value = "Europe/Dublin", Text = "Europe/Dublin" },
new SelectListItem { Value = "Europe/Isle_of_Man", Text = "Europe/Isle_of_Man" },
new SelectListItem { Value = "Europe/Jersey", Text = "Europe/Jersey" },
new SelectListItem { Value = "Europe/Lisbon", Text = "Europe/Lisbon" },
...
new SelectListItem { Value = "Europe/Berlin", Text = "Europe/Berlin" },
...
new SelectListItem { Value = "Europe/Busingen", Text = "Europe/Busingen" },
new SelectListItem { Value = "Europe/Gibraltar", Text = "Europe/Gibraltar" },
new SelectListItem { Value = "Europe/Rome", Text = "Europe/Rome" },
new SelectListItem { Value = "Europe/Vaduz", Text = "Europe/Vaduz" },
new SelectListItem { Value = "Europe/Luxembourg", Text = "Europe/Luxembourg" },
new SelectListItem { Value = "Europe/Monaco", Text = "Europe/Monaco" },
new SelectListItem { Value = "Europe/Malta", Text = "Europe/Malta" },
new SelectListItem { Value = "Europe/Amsterdam", Text = "Europe/Amsterdam" },
new SelectListItem { Value = "Europe/Oslo", Text = "Europe/Oslo" },
...
new SelectListItem { Value = "Europe/Budapest", Text = "Europe/Budapest" },
...
new SelectListItem { Value = "Europe/Belgrade", Text = "Europe/Belgrade" },
new SelectListItem { Value = "Europe/Ljubljana", Text = "Europe/Ljubljana" },
new SelectListItem { Value = "Europe/Bratislava", Text = "Europe/Bratislava" },
new SelectListItem { Value = "Europe/Paris", Text = "Europe/Paris" },
new SelectListItem { Value = "Europe/Brussels", Text = "Europe/Brussels" },
new SelectListItem { Value = "Europe/Copenhagen", Text = "Europe/Copenhagen" },
new SelectListItem { Value = "Europe/Madrid", Text = "Europe/Madrid" },
...
new SelectListItem { Value = "Europe/Bucharest", Text = "Europe/Bucharest" },
...
new SelectListItem { Value = "Europe/Chisinau", Text = "Europe/Chisinau" },
...
new SelectListItem { Value = "Europe/Kiev", Text = "Europe/Kiev" },
new SelectListItem { Value = "Europe/Mariehamn", Text = "Europe/Mariehamn" },
new SelectListItem { Value = "Europe/Sofia", Text = "Europe/Sofia" },
new SelectListItem { Value = "Europe/Tallinn", Text = "Europe/Tallinn" },
new SelectListItem { Value = "Europe/Helsinki", Text = "Europe/Helsinki" },
...
new SelectListItem { Value = "Europe/Kaliningrad", Text = "Europe/Kaliningrad" },
...
new SelectListItem { Value = "Europe/Istanbul", Text = "Europe/Istanbul" },
...
new SelectListItem { Value = "Europe/Minsk", Text = "Europe/Minsk" },
new SelectListItem { Value = "Europe/Moscow", Text = "Europe/Moscow" },
new SelectListItem { Value = "Europe/Kirov", Text = "Europe/Kirov" },
...
new SelectListItem { Value = "Africa/Asmera", Text = "Africa/Asmera" },
...
new SelectListItem { Value = "Asia/Calcutta", Text = "Asia/Calcutta" },
new SelectListItem { Value = "Asia/Colombo", Text = "Asia/Colombo" },
new SelectListItem { Value = "Asia/Katmandu", Text = "Asia/Katmandu" },
...
new SelectListItem { Value = "Asia/Rangoon", Text = "Asia/Rangoon" },
...
new SelectListItem { Value = "Asia/Saigon", Text = "Asia/Saigon" },
...
new SelectListItem { Value = "Pacific/Truk", Text = "Pacific/Truk" },
...
new SelectListItem { Value = "Pacific/Ponape", Text = "Pacific/Ponape" },
...
new SelectListItem { Value = "Antarctica/McMurdo", Text = "Antarctica/McMurdo" },
